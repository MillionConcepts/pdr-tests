...
# regenerate_test_hashes("msl", "hazcam", dump_browse=dump_browse, dump_kwargs=dump_kwargs)
...
for mission_name, datasets in DATASET_TESTING_RULES.items():
    for dataset in datasets.keys():
        ...
        regenerate_test_hashes(
            mission_name, dataset, dump_browse, dump_kwargs=dump_kwargs
        )

# regenerate hashes for specific sets within a given mission:
# for mission_name, datasets in DATASET_TESTING_RULES.items():
#     for dataset in datasets.keys():
