...
file_information = {
    ...
    "haz": {
        "manifest": IMG_FILE,
        "fn_must_contain": ['.img'],
        "url_must_contain": ['mer1om_0xxx/data/hazcam'],
        "label": "A",
    },
    ...
    "mi": {
        ...
        "fn_must_contain": ['.img'],
        "fn_regex": [r'.{21}[^a]'],
        "url_must_contain": ['mer1om_0xxx/data/mi'],
        "label": "A",
    },
    "mi_anaglyph": {
        "manifest": IMG_FILE,
    ...
    "nav": {
        ...
        "fn_must_contain": ['.img'],
        "fn_regex": [r'.{21}[^a]'],
        "url_must_contain": ['mer1om_0xxx/data/navcam'],
        "label": "A",
    },
    "nav_anaglyph": {
        "manifest": IMG_FILE,
    ...
    "pan": {
        ...
        "fn_must_contain": ['.img'],
        "fn_regex": [r'.{21}[^a]'],
        "url_must_contain": ['mer1om_0xxx/data/pancam'],
        "label": "A",
    },
    "pan_anaglyph": {
        "manifest": IMG_FILE,
