...
file_information = {
    ...
    "kem_cruise_raw": {
        "manifest": SB_FILE,
        "fn_must_contain": ['.fit'],
        "url_must_contain": ['nh-x-leisa-2-kemcruise1-v2.0/data'],
        "label": "D",
    },
    "kem_cruise_cal": {
        "manifest": SB_FILE,
        "fn_must_contain": ['.fit'],
        "url_must_contain": ['nh-x-leisa-3-kemcruise1-v2.0/data'],
        "label": "D",
    },
    ...
    "arrokoth_raw": {
        "manifest": SB_FILE,
        "fn_must_contain": ['.fit'],
        "url_must_contain": ['nh-a-leisa-2-kem1-v4.0/data'],
        "label": "D",
    },
    "arrokoth_cal": {
        "manifest": SB_FILE,
        "fn_must_contain": ['.fit'],
        "url_must_contain": ['nh-a-leisa-3-kem1-v4.0/data'],
        "label": "D",
    },
}
