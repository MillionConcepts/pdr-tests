...
class TempName:
    def __init__(self, mission_name, destination_folder=None):
        rules_module = import_module(f"pdr_tests.selection_rules.{mission_name}")
    ...
    def select_and_scrape(self):
        self.create_product_lists(self)
